    ...
    <section className="mx-auto max-w-6xl px-6 md:px-10 pt-10 pb-16">
      ...
      <div className="flex flex-col gap-4 md:gap-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
          <Tile file="New Campaign_3.jpg 1.jpg" index={3} />
          <Tile file="New Campaign_4.jpg 1.jpg" index={4} />
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
          <Tile file="New Campaign_1.jpg 1.jpg" index={5} />
          <Tile file="New Campaign_2.jpg 1.jpg" index={6} />
        </div>
      </div>
    </section>
  );
